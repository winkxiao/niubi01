						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/permission/permission-add.jsp'">
									...
									<c:forEach items="${permissionList}" var="permission">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/permission/findByIdAndAllPermission.do?id=${permission.id}" class="btn bg-olive btn-xs">赋予角色权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
